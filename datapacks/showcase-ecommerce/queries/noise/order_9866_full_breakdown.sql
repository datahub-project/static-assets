-- Drilling into order 9866 — finance flagged a refund mismatch on this one.
-- Pulling the full order + line items so we can compare against the refund record.
