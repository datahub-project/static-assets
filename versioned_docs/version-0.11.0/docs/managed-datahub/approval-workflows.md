---
title: About DataHub Approval Workflows
sidebar_label: Approval Workflows
slug: /managed-datahub/approval-workflows
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/managed-datahub/approval-workflows.md
---
