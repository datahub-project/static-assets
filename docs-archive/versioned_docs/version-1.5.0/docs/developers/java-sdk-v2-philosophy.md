---
title: Why We Hand-Crafted the Java SDK V2 (Instead of Generating It)
slug: /developers/java-sdk-v2-philosophy
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/developers/java-sdk-v2-philosophy.md
---
