...
sidebar_label: 'OSS vs Cloud: Comparison Guide'
...
| **AI Anomaly Detection (Smart Assertions)**                          | ❌  |  ✔   | Catch issues automatically                                    |           [Docs](/docs/managed-datahub/observe/smart-assertions)            |
...
| **AI Data Classification**                                                       | ❌  |  ✔   | Auto-tag sensitive data       |                   [Docs](/docs/automations/ai-term-suggestion)                   |
