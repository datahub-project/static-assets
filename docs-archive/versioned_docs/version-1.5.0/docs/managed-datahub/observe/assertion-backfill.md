---
description: >-
  This page provides an overview of Assertion Backfill (Historical Data
  Bootstrapping)
title: Backfill Assertion History
slug: /managed-datahub/observe/assertion-backfill
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/managed-datahub/observe/assertion-backfill.md
---
