---
title: DataHub GraphQL CLI
sidebar_label: GraphQL CLI
slug: /cli-commands/graphql
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/cli-commands/graphql.md
---
# DataHub GraphQL CLI
