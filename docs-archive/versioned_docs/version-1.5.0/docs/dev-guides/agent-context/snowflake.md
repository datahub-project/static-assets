---
title: Snowflake Intelligence Integration
slug: /dev-guides/agent-context/snowflake
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/dev-guides/agent-context/snowflake.md
---
