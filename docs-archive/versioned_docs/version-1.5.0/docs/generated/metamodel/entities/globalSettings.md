...
|-------|------|----------|-------------|-------------|
| sso | SsoSettings |  | SSO integrations between DataHub and identity providers |  |
| oauth | OAuthSettings |  | Settings related to the oauth authentication provider |  |
| views | GlobalViewsSettings |  | Settings related to the Views Feature |  |
| docPropagation | DocPropagationFeatureSettings |  | Settings related to the documentation propagation feature |  |
| homePage | GlobalHomePageSettings |  | Global settings related to the home page for an instance |  |
| applications | ApplicationsSettings |  | Settings related to applications. If not enabled, applications won't show up in navigation |  |
