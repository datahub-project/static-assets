...
#### create_native_user(user_id, email, display_name, password, role=None)

Create a native DataHub user with email/password authentication.

* **Parameters:**
  * **user_id** (`str`) – User identifier (will be used in the URN)
  * **email** (`str`) – User’s email address
  * **display_name** (`str`) – Full display name for the user
  * **password** (`str`) – User’s password
  * **role** (`Optional`[`str`]) – Optional role to assign (Admin, Editor, or Reader)
* **Returns:**
  li:corpuser:{user_id})
* **Return type:**
  User URN of the created user (urn
* **Raises:**
...
#### execute_graphql(query, variables=None, operation_name=None, format_exception=True, strip_unsupported_fields=False, required_fields=None)

Execute a GraphQL query against the DataHub server.

* **Parameters:**
  * **query** (`str`) – The GraphQL query string.
  * **variables** (`Optional`[`Dict`]) – Optional variables for the query.
  * **operation_name** (`Optional`[`str`]) – Optional GraphQL operation name.
  * **format_exception** (`bool`) – If True, format GraphQL errors into a readable message.
  * **strip_unsupported_fields** (`bool`) – Controls schema-compatibility projection.
  ...
  * **required_fields** (`Optional`[`List`[`str`]]) – Optional list of dot-separated field paths that must
...
* **Parameters:**
  ...
  * **platform** (`Union`[`None`, `str`, `List`[`str`]]) – Platform to filter on. If None, all platforms will be returned.
  ...
  * **container** (`Union`[`None`, `str`, `List`[`str`]]) – A container urn that entities must be within.
...
#### run_assertion(urn, save_result=None, parameters=None, async_flag=None)

Run a DataHub assertion on-demand.

* **Parameters:**
  * **urn** (`str`) – The URN of the assertion to run.
  * **save_result** (`Optional`[`bool`]) – Whether to save the result to DataHub’s backend. If not specified,
    the backend default is True (results will be saved and visible in the UI).
  * **parameters** (`Optional`[`Dict`[`str`, `str`]]) – Dynamic parameters to inject into the assertion’s SQL fragment.
  * **async_flag** (`Optional`[`bool`]) – Whether to run the assertion asynchronously. If not specified,
...
#### run_assertions(urns, save_result=None, parameters=None, async_flag=None)

Run multiple DataHub assertions on-demand.

* **Parameters:**
  * **urns** (`List`[`str`]) – List of assertion URNs to run.
  * **save_result** (`Optional`[`bool`]) – Whether to save the results to DataHub’s backend. If not specified,
    the backend default is True (results will be saved and visible in the UI).
  * **parameters** (`Optional`[`Dict`[`str`, `str`]]) – Dynamic parameters to inject into the assertions’ SQL fragments.
  * **async_flag** (`Optional`[`bool`]) – Whether to run the assertions asynchronously. If not specified,
    the backend default is False (synchronous execution with 30-second timeout).
* **Return type:**
  `Dict`
* **Returns:**
...
#### run_assertions_for_asset(urn, tag_urns=None, parameters=None, async_flag=None)

Run all assertions (or tagged subset) for a data asset on-demand.

* **Parameters:**
  * **urn** (`str`) – The URN of the data asset (e.g., dataset) whose assertions to run.
  * **tag_urns** (`Optional`[`List`[`str`]]) – Optional list of tag URNs to filter which assertions to run.
