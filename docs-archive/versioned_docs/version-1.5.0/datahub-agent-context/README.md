---
title: DataHub Agent Context
sidebar_label: Agent Context
slug: /datahub-agent-context
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/datahub-agent-context/README.md
---
...
**See [examples/langchain/](https://github.com/datahub-project/datahub/blob/master/datahub-agent-context/examples/langchain/)** for complete LangChain agent examples including:

- [simple_search.py](https://github.com/datahub-project/datahub/blob/master/datahub-agent-context/examples/langchain/simple_search.py) - Minimal example with AWS Bedrock
