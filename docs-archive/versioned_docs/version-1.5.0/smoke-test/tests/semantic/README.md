---
title: Semantic Search Smoke Tests
slug: /smoke-test/tests/semantic
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/smoke-test/tests/semantic/README.md
---
