...
hide_title: true
sidebar_label: 'SCIM Integration: MS Entra and DataHub'
slug: /managed-datahub/configuring-identity-provisioning-with-ms-entra
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/managed-datahub/configuring-identity-provisioning-with-ms-entra.md
---
