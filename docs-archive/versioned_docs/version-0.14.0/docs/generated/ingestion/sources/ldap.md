...
#### Install the Plugin
The `ldap` source works out of the box with `acryl-datahub`.
...
| <div className="path-line"><span className="path-main">attrs_list</span></div> <div className="type-name-line"><span className="type-name">array</span></div> | Retrieved attributes list  |
...
| <div className="path-line"><span className="path-main">custom_props_list</span></div> <div className="type-name-line"><span className="type-name">array</span></div> | A list of custom attributes to extract from the LDAP provider.  |
