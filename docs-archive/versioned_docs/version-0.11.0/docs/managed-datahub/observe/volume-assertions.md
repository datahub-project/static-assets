...
title: Volume Assertions
slug: /managed-datahub/observe/volume-assertions
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/managed-datahub/observe/volume-assertions.md
---
