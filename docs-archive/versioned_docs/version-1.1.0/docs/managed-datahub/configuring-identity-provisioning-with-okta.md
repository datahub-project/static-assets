...
hide_title: true
sidebar_label: 'SCIM Integration: Okta and DataHub'
slug: /managed-datahub/configuring-identity-provisioning-with-okta
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/managed-datahub/configuring-identity-provisioning-with-okta.md
---
