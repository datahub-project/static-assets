---
title: About DataHub Lineage Impact Analysis
sidebar_label: Lineage Impact Analysis
slug: /act-on-metadata/impact-analysis
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/act-on-metadata/impact-analysis.md
---
