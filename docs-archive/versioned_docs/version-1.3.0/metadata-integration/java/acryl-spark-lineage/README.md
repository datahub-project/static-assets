---
title: Spark
slug: /metadata-integration/java/acryl-spark-lineage
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/metadata-integration/java/acryl-spark-lineage/README.md
---
# Spark
...
| spark.datahub.metadata.dataset.env                               |          | PROD                    | [Supported values](/docs/graphql/enums#fabrictype). In all other cases, will fall back to PROD                                                                                       |
