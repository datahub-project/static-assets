---
title: DataHub Dataset Command
sidebar_label: Dataset Command
slug: /cli-commands/dataset
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/cli-commands/dataset.md
---
