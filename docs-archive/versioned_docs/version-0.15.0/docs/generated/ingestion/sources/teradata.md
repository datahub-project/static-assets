...
#### Install the Plugin
The `teradata` source works out of the box with `acryl-datahub`.
...
```javascript
{
  ...
  "properties": {
    ...
    "usage": {
      ...
      "default": {
        "bucket_duration": "DAY",
        "end_time": "2025-01-21T12:41:07.594489+00:00",
        "start_time": "2025-01-20T00:00:00+00:00",
...
If you've got any questions on configuring ingestion for Teradata, feel free to ping us on [our Slack](https://slack.datahubproject.io).
