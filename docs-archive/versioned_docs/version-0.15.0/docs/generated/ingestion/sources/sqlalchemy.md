...
#### Install the Plugin
The `sqlalchemy` source works out of the box with `acryl-datahub`.
...
If you've got any questions on configuring ingestion for SQLAlchemy, feel free to ping us on [our Slack](https://slack.datahubproject.io).
