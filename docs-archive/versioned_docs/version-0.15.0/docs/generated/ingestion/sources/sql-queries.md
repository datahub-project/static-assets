...
| <div className="path-line"><span className="path-main">default_dialect</span></div> <div className="type-name-line"><span className="type-name">string</span></div> | The SQL dialect to use when parsing queries. Overrides automatic dialect detection.  |
...
```javascript
{
  ...
  "properties": {
    ...
    "usage": {
      ...
      "default": {
        "bucket_duration": "DAY",
        "end_time": "2025-01-21T12:41:07.342391+00:00",
