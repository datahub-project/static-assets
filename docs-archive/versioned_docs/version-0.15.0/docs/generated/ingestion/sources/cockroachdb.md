...
#### Install the Plugin
The `cockroachdb` source works out of the box with `acryl-datahub`.
...
| <div className="path-line"><span className="path-main">scheme</span></div> <div className="type-name-line"><span className="type-name">string</span></div> | database scheme <div className="default-line default-line-with-docs">Default: <span className="default-value">cockroachdb+psycopg2</span></div> |
...
If you've got any questions on configuring ingestion for CockroachDB, feel free to ping us on [our Slack](https://slack.datahubproject.io).
