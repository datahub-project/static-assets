...
#### Install the Plugin
The `tableau` source works out of the box with `acryl-datahub`.
...
| <div className="path-line"><span className="path-main">fetch_size</span></div> <div className="type-name-line"><span className="type-name">integer</span></div> | Specifies the number of records to retrieve in each batch during a query execution. <div className="default-line default-line-with-docs">Default: <span className="default-value">250</span></div> |
...
| <div className="path-line"><span className="path-main">ingest_hidden_assets</span></div> <div className="type-name-line"><span className="type-name">boolean</span></div> | When enabled, hidden views and dashboards are ingested into Datahub. If a dashboard or view is hidden in Tableau the luid is blank. Default of this config field is True. <div className="default-line default-line-with-docs">Default: <span className="default-value">True</span></div> |
