...
| <div className="path-line"><span className="path-main">provided_configs</span></div> <div className="type-name-line"><span className="type-name">array</span></div> | Provided Configurations  |
...
### Code Coordinates
- Class Name: `datahub.ingestion.source.kafka.kafka_connect.KafkaConnectSource`
- Browse on [GitHub](https://github.com/datahub-project/datahub/blob/master/metadata-ingestion/src/datahub/ingestion/source/kafka/kafka_connect.py)
