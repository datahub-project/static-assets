...
| <div className="path-line"><span className="path-main">max_workers</span></div> <div className="type-name-line"><span className="type-name">integer</span></div> | Number of worker threads to use for parallel processing <div className="default-line default-line-with-docs">Default: <span className="default-value">60</span></div> |
...
```javascript
{
  ...
  "properties": {
    ...
    "path_to_certificates": {
      ...
      "default": "/Users/yoonhyejin/Desktop/acryl/datahub/metadata-ingestion/venv/lib/python3.10/site-packages/certifi/cacert.pem",
      "type": "string"
    },
    "is_dremio_cloud": {
    ...
    "usage": {
      ...
      "default": {
        "bucket_duration": "DAY",
        "end_time": "2025-01-21T12:41:03.269212+00:00",
