...
#### Install the Plugin
The `hive-metastore` source works out of the box with `acryl-datahub`.
...
| <div className="path-line"><span className="path-main">mode</span></div> <div className="type-name-line"><span className="type-name">Enum</span></div> | The ingested data will be stored under this platform. Valid options: ['hive', 'presto', 'presto-on-hive', 'trino'] <div className="default-line default-line-with-docs">Default: <span className="default-value">hive</span></div> |
...
#### Install the Plugin
The `presto-on-hive` source works out of the box with `acryl-datahub`.
...
If you've got any questions on configuring ingestion for Hive Metastore, feel free to ping us on [our Slack](https://slack.datahubproject.io).
