...
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/businessattributes.md
---
# Business Attributes
...
By default, business attribute is disabled. To enable Business Attributes feature, set the following configuration in [application.yaml](https://github.com/datahub-project/datahub/blob/master/metadata-service/configuration/src/main/resources/application.yaml)
