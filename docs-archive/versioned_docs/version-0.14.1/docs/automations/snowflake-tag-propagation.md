---
title: Snowflake Tag Propagation Automation
slug: /automations/snowflake-tag-propagation
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/automations/snowflake-tag-propagation.md
---
